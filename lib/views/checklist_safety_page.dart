...
class ChecklistSafetyPage extends StatelessWidget {
  const ChecklistSafetyPage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChecklistCubit, ChecklistState>(
      builder: (context, state) {
        ...
        final itens = state.itemsByCategory('seguranca');
        final nivel = state.sectionLevel('seguranca');
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: AppButton(
                      label: 'Continuar',
                      onPressed: state.isCategoryComplete('seguranca')
                          ? () => context.push('/checklist/motor-estrutura')
                          : null,
                      height: btnH,
                      borderRadius: 16,
                    ),
