...
class ChecklistEngineStructurePage extends StatelessWidget {
  const ChecklistEngineStructurePage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChecklistCubit, ChecklistState>(
      builder: (context, state) {
        ...
        final itensMotor = state.itemsByCategory('motor');
        final itensEstrutura = state.itemsByCategory('estrutura');
        final nivelMotor = state.sectionLevel('motor');
        final nivelEstrutura = state.sectionLevel('estrutura');
        final nivelGeral = _combinedLevel(nivelMotor, nivelEstrutura);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AppButton(
                      label: 'Continuar',
                      onPressed:
                          state.isCategoryComplete('motor') &&
                              state.isCategoryComplete('estrutura')
                          ? () => context.push(
